...
discriminator local <font color= #EE3F4D>X</font>    <font color=#41AE3C>*设置本地标识符*</font><br>
discriminator remote  <font color= #EE3F4D>Y</font>   <font color=#41AE3C>*设置对方标识符*</font><br>
min-tx-interval 10	 <font color=#41AE3C>*发送心跳*</font><br>
min-rx-interval 10	 <font color=#41AE3C>*接收心跳*</font><br>
ip route-static 192.168.20.24 track bfd-session ntd666  <font color=#41AE3C>*绑定路由*</font><br>
vrrp vrid 10 track bfd-session   <font color= #EE3F4D>Y</font> incereased 80 	<font color=#41AE3C>*配置VRRP和BRFD联动，一旦发现BFD会话down掉就会迅速让当前设备优先级增加80*</font><br><br>
